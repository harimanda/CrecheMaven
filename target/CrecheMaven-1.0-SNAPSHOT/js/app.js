    ...
    var signupValidationSettings = {
		...
		errorPlacement: function(error, element) {
			if (
				...
				error.insertAfter($("#nom").closest('.row'));
				element.parents("div.form-group")
				.addClass('has-error');
			} 
			else if (
	    ...
	    messages: {
	    	firstname: "Entrez les champs nom et prenoms s'il vous plait",
	    	lastname: "Entrez les champs nom et prenoms s'il vous plait",
	        email: {
	            required: "Entrez votre email",
	        ...
	        password: {
	        	...
	        	minlength: "Le mot de passe doit contenir au moins 8 caracteres,un majuscule,un chiffre,un caractere special."
	        },
	        retype_password: {
