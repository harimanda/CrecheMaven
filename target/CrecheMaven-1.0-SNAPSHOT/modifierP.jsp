...
<%@page import="java.io.PrintWriter"%>
 <%
    ...
    String ideleves = request.getParameter("idparent");
    String ide = request.getParameter("ide");
    
%>
<%
    Fonction fonc = new Fonction();
    Parents enf = new Parents(); 
%>
            ...
            <div class="app" id="app">
              ...
              <section class="section">
						...
						Modification:
                            ...
                            <% 
                                String col = "IDPARENTS";
                                   String val = ideleves;
                                   enf = fonc.selecteP(col, val);
                            ...
                            %>
                             <form action="UpdateP"  method="POST" class="form-horizontal">
                                 <div class="form-group row"> 
                                          ...
                                          <label for="inputEmail3" class="col-sm-1 form-control-label">IdParent</label>
                                    <div class="col-sm-1"> 
                                        <input type="text" class="form-control" name ="id" value = "<%=ideleves%>"></div>
                                     
                                   
                                          <label for="inputEmail3" class="col-sm-1 form-control-label">IdEleve</label>
                                    <div class="col-sm-1"> 
                                        <input type="text" class="form-control" name ="ide" value = "<%=ide%>"></div>
                                ...
                                <div class="form-group row"> <label for="inputPassword3" class="col-sm-2 form-control-label">Profession</label>
                                    <div class="col-sm-3"> 
                                        <input type="texte" class="form-control" name="professionA" value="<%=enf.getPROFESSION()%>">  </div>
                                        
                                </div>
                                <div class="form-group row"> <label for="inputPassword3" class="col-sm-2 form-control-label">Contact</label>
                                    <div class="col-sm-3"> 
                                        <input type="texte" class="form-control" name="contactA" value="<%=enf.getCONTACT()%>">  </div>
